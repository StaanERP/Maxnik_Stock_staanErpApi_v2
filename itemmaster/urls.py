...
from itemmaster.CustomViews.production_order import *
from itemmaster.CustomViews.item_stock import *
from itemmaster.CustomViews.material_request import *

urlpatterns = [
    path("graphql", csrf_exempt(GraphQLView.as_view(graphiql = True, schema=schema))),
    path('InitialDataForTable',  InitialDataForTables.as_view()),
    path("common_table_data_fetch", commanFetchQuery.as_view()),
    path("repotes_get_field_models", GetFieldsModels.as_view()),
    path("repotes_get_field_submodels/<str:model>", GetFieldsSubModels.as_view()),
    path("get_summary_data", GetReportData.as_view()),
    path("get_chart_data", GetChartData.as_view()),
    path("get_filter_condition",fetchFilterConditions.as_view()),
    path("get_report_data",GetReportEditData.as_view()),
    path("get_dashboard_chart_data",GetDashboardChartData.as_view()),
    path("get_dashboard_target_data",GetDashboardTargetData.as_view()),
    ...
    path('combo-items-creation', combo_items_creation),
    # path('sub-po-creation', sub_production_creation),
    # path('direct-rm-creation', sub_production_to_raw_material_creation),
    # path('inventory-approval-qty', fetch_total_qty_for_inventory_approval),
    # path('create-material-req-batch', create_material_request_batch),
]