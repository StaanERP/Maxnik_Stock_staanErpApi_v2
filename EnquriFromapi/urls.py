...
from EnquriFromapi.Schema import schema
...
urlpatterns = [
   ...
   path("whats_app",WhatsAppSendApi.as_view()),
   path("whats_app_chat",WhatsAppChatApi.as_view()),
   path("whats_app_file_download",WhatsAppFileDownload.as_view())
]